...
public class SugarRecord<T> {
                ...
                if (SugarRecord.class.isAssignableFrom(columnType)) {
                    ...
                    if (!"id".equalsIgnoreCase(column.getName())) {
                        if (columnType.equals(Short.class) || columnType.equals(short.class)) {
                            ...
                            Date date = (Date) column.get(this);
                            if (date != null) {
    ...
    {
        if (o instanceof SugarRecord<?>)
        {
            SugarRecord<?> c = (SugarRecord<?>) o;
            if ( this.getId() != null && this.getId().equals(c.getId()) )   // ID compare
                return true;
            else if ( super.equals(o) ) // Reference compare
                return true;
        }
